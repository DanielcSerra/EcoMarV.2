...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.event-suggestions.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.event-suggestions.partials.search', ['placeholder' => 'título ou descrição...'])
