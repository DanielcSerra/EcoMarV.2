...
@section('content')
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.events.partials.search', ['placeholder' => 'título, descrição ou local...'])
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn" href="{{ route('admin.events.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn" href="{{ route('admin.events.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.events.destroy', $item->id) }}">@csrf @method('DELETE')<button
