...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.newsletters.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.newsletters.partials.search', ['placeholder' => 'email...'])
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn" href="{{ route('admin.newsletters.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.newsletters.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.newsletters.destroy', $item->id) }}">@csrf @method('DELETE')<button
