...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.donations.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.donations.partials.search', ['placeholder' => 'nome...'])
                        ...
                        <tr>
                            ...
                            @foreach ($columns as $name => $field)
                                @php
                                    ...
                                    if ($name === 'num_donated' && $value !== null) {
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn" href="{{ route('admin.donations.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.donations.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.donations.destroy', $item->id) }}">@csrf @method('DELETE')<button
                                        class="btn danger small action-btn"><i
