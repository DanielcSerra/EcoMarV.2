...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.sponsor-signups.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.sponsor-signups.partials.search', ['placeholder' => 'nome, email ou mensagem...', 'resourceKey' => 'sponsor-signups'])
                        ...
                        <tr>
                            ...
                            <td class="actions align-right">
                                <form class="inline" method="POST"
                                    action="{{ route('admin.sponsor-signups.approve', $item->id) }}">@csrf
                                    <button class="btn success small action-btn"><i
                                            class="ri-check-line"></i><span>Aprovar</span></button></form>
                                <a class="btn ghost small action-btn"
                                    href="{{ route('admin.sponsor-signups.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.sponsor-signups.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.sponsor-signups.destroy', $item->id) }}">@csrf
