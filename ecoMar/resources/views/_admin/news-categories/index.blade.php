...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.news-categories.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.news-categories.partials.search', ['placeholder' => 'nome...'])
