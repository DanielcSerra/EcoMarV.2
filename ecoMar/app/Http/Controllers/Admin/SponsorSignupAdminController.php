...
class SponsorSignupAdminController extends Controller
{
    ...
    {
        SponsorSignup::findOrFail($id)->delete();
...
{
    $signup = SponsorSignup::findOrFail($id);
Sponsor::create([
        'name'        => $signup->nome,
        'description' => '', /* a descrição e imagem vao ficar vazias e depois no patrocinadores editamos para adicionar*/
        'category_id' => 1, /* a categoria 1 vai ser a default e depois mudamos para a correta*/
        'status'      => true,
        'approved_by' => Auth::id(),
    ]);
    ...
    return redirect()
        ->route('admin.sponsor-signups.index')
        ->with('success', 'O pedido foi aprovado e o patrocinador foi criado!');
}
}
