...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.contacts.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.contacts.partials.search', ['placeholder' => 'nome, email ou assunto...'])
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn" href="{{ route('admin.contacts.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.contacts.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.contacts.destroy', $item->id) }}">@csrf @method('DELETE')<button
