...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.event-registrations.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.event-registrations.partials.search', ['placeholder' => 'utilizador ou evento...'])
                        ...
                        <tr>
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn"
                                    href="{{ route('admin.event-registrations.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.event-registrations.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.event-registrations.destroy', $item->id) }}">@csrf
