...
@section('content')
    ...
    <div class="form-actions floating-actions">
        ...
        <a class="btn secondary btn-lg" href="{{ route('admin.events.edit', $item->id) }}">
            <i class="ri-pencil-line"></i> Editar
        </a>
        <form method="POST" action="{{ route('admin.events.destroy', $item->id) }}" class="confirm-delete">
            @csrf
            @method('DELETE')
