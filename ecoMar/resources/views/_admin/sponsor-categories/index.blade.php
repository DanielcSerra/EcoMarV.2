...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.sponsor-categories.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.sponsor-categories.partials.search', ['placeholder' => 'nome...'])
                        ...
                        <tr>
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn"
                                    href="{{ route('admin.sponsor-categories.show', $item->id) }}"><i
                                        class="ri-eye-line"></i><span>Ver</span></a>
                                <a class="btn secondary small action-btn"
                                    href="{{ route('admin.sponsor-categories.edit', $item->id) }}"><i
                                        class="ri-pencil-line"></i><span>Editar</span></a>
                                <form class="inline confirm-delete" method="POST"
                                    action="{{ route('admin.sponsor-categories.destroy', $item->id) }}">@csrf
