...
@section('content')
    <div class="page-header">
        <div>
            <h2>{{ $resource['title'] ?? "Comentários" }}</h2>
        </div>
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.comments.create') }}">
    ...
    <div class="card table-card">
        @include('_admin.comments.partials.search')
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            @foreach ($columns as $name => $field)
                                @php
                                    ...
                                    // Adaptar alguns campos específicos
                                    if ($name === 'user_id') {
                            ...
                            <td class="actions align-right">
                                <a class="btn ghost small action-btn" href="{{ route('admin.comments.show', $item->id) }}">
                                    <i class="ri-eye-line"></i><span>Ver</span>
                                </a>
                                <a class="btn secondary small action-btn" href="{{ route('admin.comments.edit', $item->id) }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ count($columns) + 2 }}" class="muted">Ainda não existem comentários.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
