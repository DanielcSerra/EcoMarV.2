...
@section('content')
    <div class="page-header">
        ...
        <div class="header-actions">
            <a class="btn primary" href="{{ route('admin.event-categories.create') }}">
    ...
    <div class="card table-card">
        <!-- Search Bar -->
        @include('_admin.event-categories.partials.search', ['placeholder' => 'nome...'])
